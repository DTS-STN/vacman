...
@AttributeOverride(name = "id", column = @Column(name = "[CLASSIFICATION_PROFILE_ID]", columnDefinition = "NUMERIC(10) IDENTITY NOT FOR REPLICATION"))
public class ClassificationProfileEntity extends AbstractEntity {
