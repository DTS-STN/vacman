<#assign emailSubject>Priorités identifiées - Demande du SGPV #${requestNumber}</#assign>
...
Veuillez accéder au lien suivant pour consulter votre demande : ${requestUrl}
