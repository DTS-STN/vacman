<#assign emailSubject>Priorities Identified - VMS Request # ${requestNumber}</#assign>
...
Access the following link to view your request employee list: ${requestMatchesUrl}
