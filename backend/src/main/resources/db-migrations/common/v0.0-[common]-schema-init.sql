...
-- email definition  -- shared values
...
(
  ...
  CONSTRAINT city_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT city_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT education_level_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT education_level_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT group_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT group_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT langequiv_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT langequiv_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT level_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT level_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT provter_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT provter_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT region_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT region_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT reqsta_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT reqsta_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT secclr_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT secclr_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
...
(
  ...
  CONSTRAINT tz_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT tz_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT title_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT title_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
...
(
  ...
  CONSTRAINT wfasta_user_create_FK FOREIGN KEY (created_by) REFERENCES [user](id),
  CONSTRAINT wfasta_user_mod_FK_1 FOREIGN KEY (last_modified_by) REFERENCES [user](id)
);
