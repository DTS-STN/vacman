...
DELETE PROFILE_CITY WHERE CITY_ID IN (SELECT ID FROM CD_CITY WHERE EXPIRY_DATE IS NOT NULL);
DELETE REQUEST_CITY WHERE CITY_ID IN (SELECT ID FROM CD_CITY WHERE EXPIRY_DATE IS NOT NULL);
