...
--changeset system:expire-cd-classification-dec-2025 context:dev dbms:mssql,h2
-- Expire some test classifications to validate expired classification dropdown handling
UPDATE CD_CLASSIFICATION SET EXPIRY_DATE=CURRENT_TIMESTAMP, USER_UPDATED='system', DATE_UPDATED=CURRENT_TIMESTAMP WHERE CODE='AS-07' AND ID=6 AND EXPIRY_DATE IS NULL;
UPDATE CD_CLASSIFICATION SET EXPIRY_DATE=CURRENT_TIMESTAMP, USER_UPDATED='system', DATE_UPDATED=CURRENT_TIMESTAMP WHERE CODE='EC-08' AND ID=24 AND EXPIRY_DATE IS NULL;
UPDATE CD_CLASSIFICATION SET EXPIRY_DATE=CURRENT_TIMESTAMP, USER_UPDATED='system', DATE_UPDATED=CURRENT_TIMESTAMP WHERE CODE='CR-05' AND ID=9 AND EXPIRY_DATE IS NULL;
