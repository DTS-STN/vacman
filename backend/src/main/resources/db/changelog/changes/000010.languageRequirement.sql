...
ALTER TABLE REQUEST_LANGUAGE_REQUIREMENT ADD CONSTRAINT RQSTLNGRQR_PK PRIMARY KEY (ID);

ALTER TABLE REQUEST_LANGUAGE_REQUIREMENT ADD CONSTRAINT RQSTLNGRQR_UK UNIQUE (LANGUAGE_REQUIREMENT_ID, REQUEST_ID);

ALTER TABLE REQUEST_LANGUAGE_REQUIREMENT
  ADD CONSTRAINT RQSTLNGRQR_LANGUAGE_REQUIREMENT_FK FOREIGN KEY
  (
