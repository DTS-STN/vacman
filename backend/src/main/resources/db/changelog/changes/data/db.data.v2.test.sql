...
INSERT INTO [USER] ([ID], [BUSINESS_EMAIL_ADDRESS], [BUSINESS_PHONE_NUMBER], [FIRST_NAME], [INITIAL], [LANGUAGE_ID],
...
INSERT INTO [PROFILE] ([USER_ID], [USER_ID_HR_ADVISOR], [WFA_STATUS_ID], [CLASSIFICATION_ID], [CITY_ID],
...
VALUES
    ...
    ('840', '840', 1, 1, 1, 1, 1, 1, '5551113333', 'maxwell.r.haley@gmail.com', 'false', 'false',
     'false', 'A normal sized human.', 'system', CURRENT_TIMESTAMP),
    ('840', '840', 1, 1, 1, 1, 1, 2, '5551113333', 'maxwell.r.haley@gmail.com', 'false', 'false',
     'false', 'A normaler sized human.', 'system', CURRENT_TIMESTAMP);
