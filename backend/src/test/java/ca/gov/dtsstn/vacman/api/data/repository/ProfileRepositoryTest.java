...
class ProfileRepositoryTest {
	...
	@Nested
	@DisplayName("Employee Name Specification Tests")
	class EmployeeNameSpecificationTests {

		@Test
		@DisplayName("hasEmployeeNameContaining should find profiles by employee first name")
		void testHasEmployeeNameContainingFirstName() {
			final var userWithSpecificName = userRepository.save(
				UserEntity.builder()
					.language(languageRepository.findByCode("EN").orElseThrow())
					.userType(userTypeRepository.findByCode("employee").orElseThrow())
			...
			final var profileWithSpecificName = profileRepository.save(
				ProfileEntity.builder()
					.user(userWithSpecificName)
					.profileStatus(statusApproved)
					.build());

			@SuppressWarnings("unused")
			final var profileWithDifferentName = profileRepository.save(
				ProfileEntity.builder()
					.user(testUser)
					.profileStatus(statusApproved)
					.build());
			...
			final var results = profileRepository.findAll(
				ProfileRepository.hasEmployeeNameContaining("John"));

			assertThat(results).hasSize(1);
			assertThat(results.get(0).getId()).isEqualTo(profileWithSpecificName.getId());
		}

		@Test
		@DisplayName("hasEmployeeNameContaining should find profiles by employee last name")
		void testHasEmployeeNameContainingLastName() {
			final var userWithSpecificName = userRepository.save(
				UserEntity.builder()
					.language(languageRepository.findByCode("EN").orElseThrow())
					.userType(userTypeRepository.findByCode("employee").orElseThrow())
			...
			final var results = profileRepository.findAll(
				ProfileRepository.hasEmployeeNameContaining("Smith"));
		...
		@Test
		@DisplayName("hasEmployeeNameContaining should find profiles by employee middle name")
		void testHasEmployeeNameContainingMiddleName() {
			final var userWithSpecificName = userRepository.save(
				UserEntity.builder()
					.language(languageRepository.findByCode("EN").orElseThrow())
					.userType(userTypeRepository.findByCode("employee").orElseThrow())
					.microsoftEntraId("08080808-0808-0808-0808-080808080808")
					.businessEmailAddress("robert.james.brown@example.com")
					.firstName("Robert")
					.middleName("James")
					.lastName("Brown")
					.build());
			...
			final var results = profileRepository.findAll(
				ProfileRepository.hasEmployeeNameContaining("James"));
		...
		@Test
		@DisplayName("hasEmployeeNameContaining should find profiles by partial employee name")
		void testHasEmployeeNameContainingPartialName() {
			final var userWithSpecificName = userRepository.save(
				UserEntity.builder()
					.language(languageRepository.findByCode("EN").orElseThrow())
					.userType(userTypeRepository.findByCode("employee").orElseThrow())
					.microsoftEntraId("09090909-0909-0909-0909-090909090909")
					.businessEmailAddress("alexander.wilson@example.com")
					.firstName("Alexander")
					.lastName("Wilson")
					.build());
			...
			final var results = profileRepository.findAll(
				ProfileRepository.hasEmployeeNameContaining("xand"));
		...
		@Test
		@DisplayName("hasEmployeeNameContaining should be case insensitive")
		void testHasEmployeeNameContainingCaseInsensitive() {
			final var userWithSpecificName = userRepository.save(
				UserEntity.builder()
					.language(languageRepository.findByCode("EN").orElseThrow())
					.userType(userTypeRepository.findByCode("employee").orElseThrow())
					.microsoftEntraId("10101010-1010-1010-1010-101010101010")
					.businessEmailAddress("michael.johnson@example.com")
					.firstName("Michael")
					.lastName("Johnson")
					.build());
			...
			final var results = profileRepository.findAll(
				ProfileRepository.hasEmployeeNameContaining("michael"));
		...
		@Test
		@DisplayName("hasEmployeeNameContaining should return empty when no profiles match")
		void testHasEmployeeNameContainingNoMatches() {
			@SuppressWarnings("unused")
			final var profile = profileRepository.save(
				ProfileEntity.builder()
					.user(testUser)
			...
			final var results = profileRepository.findAll(
				ProfileRepository.hasEmployeeNameContaining("NonexistentName"));

			assertThat(results).isEmpty();
		}

		@Test
		@DisplayName("hasEmployeeNameContaining should return null specification when name is null")
		void testHasEmployeeNameContainingNullName() {
			@SuppressWarnings("unused")
			final var profile = profileRepository.save(
				ProfileEntity.builder()
					.user(testUser)
			...
			// Should still find the profile because the null specification is ignored
			assertThat(results).isNotEmpty();
		}

		@Test
		@DisplayName("hasEmployeeNameContaining should return null specification when name is empty")
		void testHasEmployeeNameContainingEmptyName() {
			@SuppressWarnings("unused")
			final var profile = profileRepository.save(
				ProfileEntity.builder()
					.user(testUser)
			...
			// Should still find the profile because the empty specification is ignored
			assertThat(results).isNotEmpty();
		}
	}
