...
${DIAGRAM_TYPE="Component"} <!-- Architecture diagram type -->
${DETAIL_LEVEL="Comprehensive"} <!-- Level of detail to include -->
${INCLUDES_CODE_EXAMPLES=true} <!-- Include sample code to illustrate patterns -->
${INCLUDES_IMPLEMENTATION_PATTERNS=true} <!-- Include detailed implementation patterns -->
${INCLUDES_DECISION_RECORDS=false} <!-- Include architectural decision records -->
${FOCUS_ON_EXTENSIBILITY=true} <!-- Emphasize extension points and patterns -->
