...
import type { Route } from '../employee-profile/+types/referral-preferences';
...
import { refferralPreferencesSchema } from '~/routes/hr-advisor/employee-profile/validation.server';
