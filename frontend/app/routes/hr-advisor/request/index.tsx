...
import { EMPLOYMENT_TENURE, REQUEST_STATUSES } from '~/domain/constants';
...
export async function loader({ context, request, params }: Route.LoaderArgs) {
  ...
  const [allLocalizedCities, allLocalizedProcessTypes] = await Promise.all([
            ...
            <ProfileCard title={t('app:hr-advisor-referral-requests.process-information')} params={params}>
              <DescriptionList>
                ...
                <DescriptionListItem term={t('app:process-information.non-advertised-appointment')}>
                  {loaderData.appointmentNonAdvertised ?? t('app:hr-advisor-referral-requests.not-provided')}
                </DescriptionListItem>
