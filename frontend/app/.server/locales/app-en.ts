...
const appEn: Translations = {
  ...
  personalInformation: {
    ...
    personalPhoneHelpMessagePrimary: 'Cell, home, or other. For example +1 (615) 555-5555',
    workPhoneHelpMessagePrimary: 'For example: +1 (615) 555-5555',
    workPhoneExtension: 'Extension (if applicable)',
    workPhoneExtensionHelpMessagePrimary: 'For example: 1234',
