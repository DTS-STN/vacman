export default {
  ...
  'process-information': {
    ...
    'errors': {
      ...
      'selection-process-number-max-length': 'The selection process number must not exceed 30 characters.',
      'approval-received-required': 'Approval received is required.',
      'performed-duties-required': 'Performed duties is required.',
      'priority-entitlement-rationale-required': 'Rationale is required.',
      'priority-entitlement-rationale-max-length': 'Rationale must not exceed 200 characters.',
      'priority-entitlement-required': 'Result in priority entitlement is required.',
      ...
      'employment-equities-required': 'Employment equity required.',
  ...
  'hiring-manager-referral-requests': {
    ...
    'delete-request': {
      ...
      'success-msg': 'Request deleted successfully.',
    },
  ...
  'position-information': {
    ...
    'errors': {
      ...
      'title-fr-max-length': 'Title in French cannot exceed 200 characters.',
  ...
  'submission-details': {
    ...
    'hr-advisor': {
      ...
      'is-submitter-a-sub-delegate': 'Is {{name}} a staffing sub-delegated manager?',
    },
    'hiring-manager': {
      'submitter': 'Submitter: {{name}}',
      'are-you-hiring-manager-for-request': 'Are you the hiring manager for this request?',
      'are-you-a-subdelegate': 'Are you a staffing sub-delegated manager?',
    },
    ...
    'sub-delegate-title': 'Staffing sub-delegated manager',
    'errors': {
      'no-user-found-with-this-email': 'No user found with this email address.',
      'is-submitter-hiring-manager-required': '"Is submitter the hiring manager for this request" field is required.',
      'is-submitter-a-sub-delegate-required': '"Is submitter a staffing sub-delegated manager" field is required.',
      'are-you-hiring-manager-for-request-required': '"Are you the hiring manager for this request" field is required.',
      'are-you-a-subdelegate-required': '"Are you a staffing sub-delegated manager" field is required.',
      ...
      'is-hiring-manager-sub-delegate-required': '"Is the hiring manager staffing sub-delegated manager" field is required.',
      'sub-delegate-email-required': 'Staffing sub-delegated manager email address is required.',
  ...
  'matches': {
    ...
    'referral-request': 'Priority clearance Request',
    'request-id': 'Request ID',
    'request-date': 'Request date',
    'hiring-manager': 'Hiring manager',
    'hr-advisor': 'HR advisor',
