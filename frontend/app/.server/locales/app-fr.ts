...
export default {
  ...
  'personal-information': {
    ...
    'errors': {
      ...
      'work-email-required': "L'adresse courriel professionnelle est requise.",
      ...
      'personal-phone-required': 'Le numéro de téléphone personnel est requis.',
  ...
  'process-information': {
    ...
    'errors': {
      ...
      'priority-entitlement-rationale-required': 'Justification est requise.',
      'priority-entitlement-rationale-max-length': 'La justification ne doit pas dépasser 200 caractères.',
      'priority-entitlement-required': 'Confère un droit de priorité est requise.',
      'non-advertised-appointment-required': "Raison de la nomination d'un processus non-annoncé est requise.",
      'selection-process-type-required': 'Type de processus de sélection est requis.',
      'work-schedule-required': 'Horaire de travail est requis.',
      ...
      'employment-equities-required': "Équité en matière d'emploi requise.",
      'employment-equity-identified-required': "Équité en matière d'emploi identifié est requis.",
    },
  },
  ...
  'hiring-manager-referral-requests': {
    ...
    'submit': 'Soumettre',
    'notice-line-1':
      "Le processus d'autorisation en matière de priorité ministériel est requis avant d'entreprendre un processus interne ou externe, annoncée ou non annoncée, dont l'intention mènerait à une dotation indéterminée (mutations et nominations), à l'exception\u00A0:",
    ...
    'notice-line-6':
      "Le processus d'autorisation de la CFP est requis avant d'entreprendre un processus interne ou externe, annoncée ou non annoncée, dont l'objectif mènerait à des nominations pour une période indéterminée ou déterminée.",
    'notice-line-7':
