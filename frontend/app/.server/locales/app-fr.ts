...
export default {
  ...
  'profile': {
    ...
    'profile-completion-progress': "État d'avancement de la création du profil",
  ...
  'employee-profile': {
    'about-para-1':
      "Vérifiez les informations du profil ci-dessous avant de les approuver. Si des modifications sont nécessaires, contactez directement l'employé-e pour en discuter et les mettre à jour avant de les approuver.",
    'back': 'Retour à la section employés',
  ...
  'form': {
    ...
    'pickup-request': "M'assigner la demande",
    'vms-not-required': 'Autorisation SGPV non obligatoire',
    'run-matches': 'Lancer le repérage',
  ...
  'personal-information': {
    ...
    'errors': {
      ...
      'givenName-required': 'Le prénom est obligatoire.',
      'personal-record-identifier-required': "Le code d'identification du dossier personnel (CIDP) est obligatoire.",
      'personal-record-identifier-invalid': "Le code d'identification du dossier personnel (CIDP) est invalide.",
      'language-of-correspondence-required': 'La langue de préférence pour la correspondance est obligatoire.',
      'work-email-required': "L'adresse courriel professionnelle est obligatoire.",
      'work-email-invalid': "L'adresse courriel professionnelle n'est pas valide.",
      'personal-email-required': "L'adresse du courriel personnel est obligatoire.",
      'personal-email-invalid': "L'adresse du courriel personnel n'est pas valide.",
      'work-phone-required': 'Le numéro de téléphone professionnel est obligatoire.',
      'work-phone-invalid': "Le numéro de téléphone professionnel n'est pas valide.",
      'personal-phone-required': 'Le numéro de téléphone personnel est obligatoire.',
      'personal-phone-invalid': "Le numéro de téléphone personnel n'est pas valide.",
    },
  },
  'employment-information': {
    'page-title': "Informations sur l'emploi",
    'substantive-position-heading': 'Poste substantif',
    'substantive-position-group-and-level': 'Groupe et niveau du poste',
    ...
    'wfa-effective-date': "Date d'effet",
    'wfa-end-date': 'Date de fin',
    ...
    'errors': {
      ...
      'wfa-effective-date': {
        ...
        'required-year': "L'année de la date d'effet de votre statut de RE/TC est obligatoire.",
        'invalid-year': "L'année de la date d'effet de votre statut de RE/TC n'est pas valide.",
        'required-month': "Le mois de la date d'effet de votre statut de RE/TC est obligatoire.",
        'invalid-month': "Le mois de la date d'effet de votre statut de RE/TC n'est pas valide.",
        'required-day': "Le jour de la date d'effet de votre statut de RE/TC est obligatoire.",
      ...
      'wfa-end-date': {
        ...
        'required-year': "L'année de fin de votre statut de RE/TC est obligatoire.",
        'invalid-year': "L'année de fin de votre statut de RE/TC n'est pas valide.",
        'required-month': 'Le mois de fin de votre statut de RE/TC est obligatoire.',
        'invalid-month': "Le mois de fin de votre statut de RE/TC n'est pas valide.",
        'required-day': 'Le jour de fin de votre statut de RE/TC est obligatoire.',
        'invalid-day': "Le jour de fin de votre statut de RE/TC n'est pas valide.",
      },
      'hr-advisor-required': 'Le-la conseiller-ère en RH est obligatoire.',
    },
  },
  'referral-preferences': {
    ...
    'select-all-cities-help message':
      'Vous pouvez choisir autant de villes que vous le souhaitez dans chaque province. «\u00a0Sélectionnez toutes les villes\u00a0» sélectionnera toutes les villes disponibles pour la province choisie.',
    ...
    'errors': {
      'language-referral-type-required': 'Le profil linguistique est obligatoire.',
      ...
      'classification-required': 'Le groupe et le niveau de classification sont obligatoires.',
      ...
      'work-location-province-required': 'La province du lieu de travail est obligatoire.',
      'work-location-city-required': 'La ville de travail est obligatoire.',
      ...
      'referral-availibility-required': 'La confirmation de disponibilité pour les références est obligatoire.',
      'alternate-opportunity-required': "La confirmation d'intérêt pour l'échange de poste est obligatoire.",
    },
    'choice-tag': {
      city: 'ville',
      cities: 'villes',
  ...
  'process-information': {
    ...
    'employment-equity-identified-help-message': "Preuves à l'appui obligatoires",
    ...
    'preferred-employment-equities': "Quel besoin organisationnel d'équité en matière d'emploi a été identifié?",
    'preferred-employment-equities-help-message': "Sélectionnez tout ce qui s'applique",
    'projected-start-date': 'Date de début prévue',
    'projected-end-date': 'Date de fin prévue',
    'yes': 'Oui',
    'no': 'Non',
    'errors': {
      'selection-process-number-invalid': "Le numéro du processus de sélection n'est pas valide.",
      'selection-process-number-max-length': 'Le numéro du processus de sélection ne doit pas dépasser 30 caractères.',
      'approval-received-required': 'Approbation reçue est obligatoire.',
      'performed-duties-required': 'Exercé les mêmes fonctions est obligatoire.',
      'priority-entitlement-rationale-required': 'Justification est obligatoire.',
      'priority-entitlement-rationale-max-length': 'La justification ne doit pas dépasser 200 caractères.',
      'priority-entitlement-required': 'Confère un droit de priorité est obligatoire.',
      ...
      'projected-start-date': {
        ...
        'required-year': "L'année de la date de début prévue est obligatoire.",
        'invalid-year': "L'année de la date de début prévue n'est pas valide.",
        'required-month': 'Le mois de la date de début prévue est obligatoire.',
        'invalid-month': "Le mois de la date de début prévue n'est pas valide.",
        'required-day': 'Le jour de la date de début prévue est obligatoire.',
      ...
      'projected-end-date': {
        ...
        'required-year': "L'année de la date de fin prévue est obligatoire.",
        'invalid-year': "L'année de la date de fin prévue n'est pas valide.",
        'required-month': 'Le mois de la date de fin prévue est obligatoire.',
        'invalid-month': "Le mois de la date de fin prévue n'est pas valide.",
        'required-day': 'Le jour de la date de fin prévue est obligatoire.',
        'invalid-day': "Le jour de la date de fin prévue n'est pas valide.",
      },
      'employment-tenure-required': 'Durée est obligatoire.',
      'employment-equities-required': "Équité en matière d'emploi obligatoire.",
      'employment-equity-identified-required': "Équité en matière d'emploi identifié est obligatoire.",
    },
  },
  ...
  'hr-advisor-employees-table': {
    ...
    'employee-work-email': "Adresse courriel professionnelle de l'employé-e",
    ...
    'errors': {
      ...
      'email-invalid': "L'adresse courriel n'est pas valide.",
  ...
  'hiring-manager-dashboard': {
    'page-title': "Tableau du gestionnaire d'embauche",
    'page-heading': "Tableau du gestionnaire d'embauche",
    'requests': 'Demandes',
  },
  'hiring-manager-referral-requests': {
    ...
    'request-completion-progress': "État d'avancement de la demande",
    'page-description':
      'Remplissez toutes les sections détaillant le processus, le poste et les qualifications obligatoires, puis soumettez-les pour approbation',
    'process-information': 'Information sur le processus',
    'position-information': 'Informations sur le poste',
    'somc-conditions': "Énoncé des critères de mérite et conditions d'emploi",
    'submission-details': 'Détails de la soumission',
    'add-somc-conditions': "énoncé des critères de mérite et conditions d'emploi",
    'add-submission-details': 'détails de la soumission',
    'edit-process-information': 'informations sur le processus',
    'edit-position-information': 'informations sur le poste',
    'edit-somc-conditions': "énoncés des critères de mérite et conditions d'emploi",
    ...
    'submit': 'Soumettre',
    'notice-line-1':
      "Le processus d'autorisation en matière de priorité ministériel est obligatoire avant d'entreprendre un processus interne ou externe, annoncée ou non annoncée, dont l'intention mènerait à une dotation indéterminée (mutations et nominations), à l'exception\u00A0:",
    ...
    'notice-line-6':
      "Le processus d'autorisation de la CFP est obligatoire avant d'entreprendre un processus interne ou externe, annoncée ou non annoncée, dont l'objectif mènerait à des nominations pour une période indéterminée ou déterminée.",
    'notice-line-7':
    ...
    'request-incomplete-somc-information':
      "Veuillez remplir tous les champs obligatoires dans la section des critères de mérite et des conditions d'emploi avant de soumettre votre demande.",
    ...
    'feedback-submitted-alert-msg': "Rétroaction soumise avec succès! Un-e conseiller-ère RH l'examinera pour approbation.",
  ...
  'hr-advisor-referral-requests': {
    ...
    'position-information': 'Informations sur le poste',
    'somc-conditions': "Énoncé des critères de mérite et conditions d'emploi",
    'somc-conditions-link': "Voir Énoncé des critères de mérite et conditions d'emploi",
    'submission-details': 'Détails de la soumission',
    ...
    'no-match-found-alert-msg': 'Processus de repérage effectué - aucune candidature repérée.',
    ...
    'errors': {
      'psc-clearance-number-required': 'Autorisation CFP est obligatoire.',
      'psc-clearance-number-invalid': "L'autorisation de la CFP n'est pas valide.",
    },
  },
  'referral-request': "Demande d'autorisation en matière de priorité",
  'position-information': {
    ...
    'errors': {
      'position-number-required': 'Le numéro de poste est obligatoire.',
      ...
      'title-fr-max-length': 'Le titre en français ne peut pas dépasser 200 caractères.',
      'provinces-required': 'La province est obligatoire.',
  ...
  'somc-conditions': {
    'page-title': "Énoncé des critères de mérite et conditions d'emploi",
    'page-content':
      "L'énoncé de critères de mérite (ECM) définit les qualifications (critères de mérite) obligatoires pour un poste, ce qui est fondamental pour l'évaluation. Par conséquent, il est attendu que les gestionnaires examinent l'ECM pour s'assurer qu'il est inclusif et que  les mesures nécessaires soient prises afin d'atténuer ou éliminer tout biais ou obstacle potentiel.",
    'english-somc-label': "Énoncé des critères de mérite et conditions d'emploi - Anglais",
    ...
    'errors': {
      'english-somc-required': "Un énoncé de critères de mérite et conditions d'emploi en anglais est obligatoire.",
      'french-somc-required': "Un énoncé de critères de mérite et conditions d'emploi en français est obligatoire.",
    },
  ...
  'submission-details': {
    ...
    'hiring-manager': {
      ...
      'are-you-hiring-manager-for-request': "Êtes-vous le-la gestionnaire d'embauche pour cette demande?",
    ...
    'branch-or-service-canada-region': 'Direction générale ou Région de Service Canada',
    'directorate': 'Direction',
    'preferred-language-of-correspondence': 'Langue de préférence pour la correspondance',
    ...
    'errors': {
      'no-user-found-with-this-email': "Aucun utilisateur n'a été trouvé avec cette adresse courriel.",
      'is-submitter-hiring-manager-required':
        "Le champ «\u00a0Est-ce que le (la) soumissionnaire est le (la) gestionnaire d'embauche pour cette demande\u00a0» est obligatoire. ",
      'is-submitter-a-sub-delegate-required':
        'Le champ «\u00a0Le (la) soumissionnaire est-il (elle)  un-e gestionnaire subdélégué-e à la dotation\u00a0» est obligatoire.',
      'are-you-hiring-manager-for-request-required':
        "Le champ «\u00a0Êtes-vous le (la) gestionnaire d'embauche pour cette demande\u00a0» est obligatoire.",
      'are-you-a-subdelegate-required':
        'Le champ «\u00a0Êtes-vous un-e gestionnaire subdélégué-e à la dotation\u00a0» est obligatoire.',
      'hiring-manager-email-required': "L'adresse courriel du (de la) gestionnaire d'embauche est obligatoire.",
      ...
      'is-hiring-manager-sub-delegate-required':
        "Le champ «\u00a0Le (la) gestionnaire d'embauche est-il (elle) gestionnaire subdélégué-e à la dotation\u00a0» est obligatoire.",
  ...
  'requests-tables': {
    ...
    'action': 'Action',
    'view': 'Voir',
    'view-link': "Voir la demande avec l'identifiant {{requestId}}",
    'copy': 'Copier',
  ...
  'matches': {
    ...
    'feedback': {
      success: "Rétroaction-s soumise-s avec succès ! Un-e conseiller-ère RH l'examinera pour approbation.",
      approved:
    ...
    'errors': {
      ...
      'feedback-required': 'Une rétroaction est obligatoire.',
      ...
      'retraining-required':
        "La confirmation concernant l'application et/ou la prise en compte des droits en matière de recyclage est obligatoire.",
      'feedback-missing': 'Veuillez compléter toutes les rétroactions avant de soumettre.',
    },
  },
  'matches-tables': {
    'approved': 'Approuvé',
