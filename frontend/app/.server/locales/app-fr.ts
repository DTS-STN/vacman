...
export default {
  ...
  'submission-details': {
    ...
    'errors': {
      ...
      'hiring-manager-email-unverified': 'Please verify the Hiring manager email address by pressing Search button.',
      ...
      'sub-delegate-email-unverified': 'Please verify the Sub-delegate email address by pressing Search button.',
      'branch-or-service-canada-region-required': 'La direction générale ou la région de Service Canada est requise.',
      'directorate-required': 'La direction est requise.',
