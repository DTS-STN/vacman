...
export const notify = v.object({
  ...
  GC_NOTIFY_ENGLISH_TEMPLATE_ID: v.optional(v.string()),
  GC_NOTIFY_FRENCH_TEMPLATE_ID: v.optional(v.string()),
  GC_NOTIFY_API_URL: v.optional(v.string()),

  // Interop API settings
  INTEROP_API_BASE_URI: v.optional(v.string()),
