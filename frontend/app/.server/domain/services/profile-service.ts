...
export type ProfileService = {
  ...
  // GET /api/v1/profiles/me - Get current user's active profile (singular)
  getCurrentUserProfile(params: Pick<ProfileQueryParams, 'active'>, accessToken: string): Promise<Profile>;
