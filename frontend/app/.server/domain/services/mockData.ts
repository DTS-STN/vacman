  ...
  const profileTemplates = [
    {
      ...
      data: {
        ...
        languageOfCorrespondence: { id: 0, code: 'EN', nameEn: 'English', nameFr: 'Anglais' },
    ...
    },
    {
      ...
      data: {
        ...
        profileStatus: { id: 0, code: 'PENDING', nameEn: 'Pending', nameFr: 'En attente' },
        createdBy: 'system',
    ...
    },
    {
      ...
      data: {
        ...
        languageOfCorrespondence: { id: 2, code: 'FR', nameEn: 'French', nameFr: 'Français' },
        profileStatus: { id: 1, code: 'APPROVED', nameEn: 'Approved', nameFr: 'Approuvé' },
        createdBy: 'system',
