...
export function getMockNonAdvertisedAppointmentService(): NonAdvertisedAppointmentService {
  return {
    ...
    getById: (id: string) => Promise.resolve(mockService.getById(id)),
    findById: (id: string) => Promise.resolve(mockService.findById(id)),
    ...
    getLocalizedById: (id: string, language: Language) => Promise.resolve(mockService.getLocalizedById(id, language)),
    findLocalizedById: (id: string, language: Language) => Promise.resolve(mockService.findLocalizedById(id, language)),
