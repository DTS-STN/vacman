...
//   reviewedBy?: User;
//   approvedBy?: User;
//   priorityLevel?: PriorityLevel; // was priorityLevelId
//   profileStatus: ProfileStatus;  // was profileStatusId
//   privacyConsentInd?: boolean;
//   userCreated: string;
//   dateCreated: string;
//   userUpdated?: string;
...
//   givenName?: string;
//   personalRecordIdentifier?: string;
//   preferredLanguage?: LanguageOfCorrespondence; // was preferredLanguageId
//   workEmail: string;
//   personalEmail?: string;
//   workPhone?: string;
//   personalPhone?: string;
...
// export type UserEmploymentInformation = {
//   substantivePosition?: Classification; // guessing from naming
//   branchOrServiceCanadaRegion?: Branch;
...
// export type UserReferralPreferences = {
//   languageReferralTypes?: LanguageReferralType[]; // was languageReferralTypeIds
//   classifications?: Classification[];             // was classificationIds
//   workLocationProvince?: Province;
//   workLocationCities?: City[];                    // was workLocationCitiesIds
//   availableForReferralInd?: boolean;
//   interestedInAlternationInd?: boolean;
//   employmentTenures?: EmploymentTenure[];         // was employmentTenureIds
// };
