...
//TODO: Remove DashboardActionCard when the "Register as" screen is removed
interface DashboardActionCardProps {
  dashboard: 'employee' | 'hiring-manager' | 'profile';
  icon: IconProp;
  title: string;
  body?: string;
}

export function DashboardActionCard({ dashboard, icon, title, body }: DashboardActionCardProps): JSX.Element {
  return (
    <Form method="post">
