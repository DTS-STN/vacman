...
import { i18nRedirect, i18nRedirectWithAcceptLanguage } from '~/.server/utils/route-utils';
...
describe('route-utils', () => {
  ...
  describe('i18nRedirectWithAcceptLanguage', () => {
    it('should use language from URL when available', () => {
      const request = new Request('http://example.com/en/', {
        headers: { 'accept-language': 'fr' },
      });
      const result = i18nRedirectWithAcceptLanguage('routes/index.tsx', request);
